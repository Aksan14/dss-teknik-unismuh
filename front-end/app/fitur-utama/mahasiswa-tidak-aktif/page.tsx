        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-red-600">Data mahasiswa dengan status tidak aktif</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg shadow-md p-6 mb-6">
          <div className="flex flex-wrap gap-4 justify-between items-center">
            <p className="text-red-900 font-semibold">
              Total Tidak Aktif: <span className="text-2xl text-red-600">{loading ? '-' : filteredData.length.toLocaleString()}</span>
            </p>
            {totalPages > 1 && (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-red-100 border-b border-gray-200">
                  ...
                  <th className="px-6 py-4 text-left font-semibold text-red-900">Angkatan</th>
                  ...
                  <th className="px-6 py-4 text-left font-semibold text-red-900">SKS Diambil</th>
                  <th className="px-6 py-4 text-left font-semibold text-red-900">MK Lulus</th>
                  <th className="px-6 py-4 text-left font-semibold text-red-900">MK Diulang</th>
                  <th className="px-6 py-4 text-left font-semibold text-red-900">SKS MK Diulang</th>
                  <th className="px-6 py-4 text-left font-semibold text-red-900">Kategori</th>
                  <th className="px-6 py-4 text-left font-semibold text-red-900">Aksi</th>
                </tr>
              </thead>
              <tbody>
                {loading ? (
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-1">
                  ...
                  {getPageNumbers().map((page) => (
                    <button key={page} onClick={() => setCurrentPage(page)} disabled={loading} className={`px-3 py-1 rounded-lg border ${page === currentPage ? 'bg-red-500 text-white border-red-500' : 'border-gray-300 hover:bg-gray-100'} disabled:opacity-50`}>
                      {page}
                    </button>
                  ))}
