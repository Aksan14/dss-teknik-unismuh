...
export default function MahasiswaAktif() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('http://localhost:8080/mahasiswa/aktif');
      ...
      <main className="px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg shadow-md p-6 mb-8">
          <p className="text-green-900 font-semibold">
            Total Mahasiswa Aktif: <span className="text-2xl text-green-600">{loading ? '-' : data.length}</span>
          </p>
        </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-green-100 border-b border-gray-200">
                  ...
                  <th className="px-6 py-4 text-left font-semibold text-green-900">Jurusan</th>
                  ...
                  <th className="px-6 py-4 text-left font-semibold text-green-900">SKS Belum Lulus</th>
                </tr>
              </thead>
              <tbody>
                {loading ? (
